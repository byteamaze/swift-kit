...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(NSImage *)image type:(YYImageType)type quality:(CGFloat)quality;
...
@interface NSImage (YYImageCoder)
...
// CGImageRef
-(_Nullable CGImageRef) cgImageRef;
...
// TODO CG_EXTERN UIImageOrientation YYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
// TODO CG_EXTERN NSInteger YYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
// TODO CG_EXTERN CGImageRef _Nullable YYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
