...
/**
 ...
 @discussion It is a fully compatible `NSImageView` subclass.
 ...
 controlled with the NSImageView methods `-startAnimating`, `-stopAnimating` and `-isAnimating`.
 ...
 */
@interface YYAnimatedImageView : NSImageView
...
/**
 ...
 Subclass a NSImage and implement this protocol, so that instances of that class 
...
- (nullable NSImage *)animatedImageFrameAtIndex:(NSUInteger)index;
